...
# ⚠️ Careful: this will drop all existing data
db.drop_all()
db.create_all()
...
venue3 = Venue(
    ...
    phone="415-000-1234",
    image_link="https://images.unsplash.com/photo-1485686531765-ba63b07845a7?ixlib=rb-1.2.1&auto=format&fit=crop&w=747&q=80",
...
artist3 = Artist(
    ...
    image_link="https://images.unsplash.com/photo-1558369981-f9ca78462e61?ixlib=rb-1.2.1&auto=format&fit=crop&w=794&q=80",
    seeking_venue=False
)
...
# Commit to DB
# ------------------------
db.session.add_all([venue1, venue2, venue3, artist1, artist2, artist3, show1, show2, show3])
db.session.commit()
